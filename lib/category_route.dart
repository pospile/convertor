...
import 'package:convertor/api.dart';
...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  Future<void> _retrieveLocalCategories() async {
    ...
    final jsonFromBundle = DefaultAssetBundle.of(context)
        .loadString('assets/data/regular_units.json');
    final data = JsonDecoder().convert(await jsonFromBundle);
    if (data is! Map) {
  ...
  Widget build(BuildContext context) {
    ...
    return Backdrop(
      ...
      backPanel: listView,
      frontTitle: Text('Převod jednotek'),
      backTitle: Text('Výběr kategorie'),
    );
  }
}
